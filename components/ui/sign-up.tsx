      ...
      <section className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            {onBackToHome && (
              <div className="animate-element animate-delay-50 self-start">
                <LiquidButton 
                  onClick={onBackToHome}
                  className="text-white font-semibold text-sm drop-shadow-sm px-6 py-3"
                  size="default"
                >
            ...
            <form className="space-y-5" onSubmit={onSignUp}>
              ...
              <div className="animate-element animate-delay-400">
                ...
                <GlassInputWrapper>
                  <div className="relative">
                    <input name="password" type={showPassword ? 'text' : 'password'} required placeholder="Create a password" className="w-full bg-transparent text-sm p-4 pr-12 rounded-2xl focus:outline-none" />
              ...
              <div className="animate-element animate-delay-500">
                ...
                <GlassInputWrapper>
                  <div className="relative">
                    <input name="confirmPassword" type={showConfirmPassword ? 'text' : 'password'} required placeholder="Confirm your password" className="w-full bg-transparent text-sm p-4 pr-12 rounded-2xl focus:outline-none" />
              ...
              <div className="animate-element animate-delay-600 flex items-start gap-3 text-sm">
                <input type="checkbox" name="terms" required className="custom-checkbox mt-1" />
            ...
            <button 
              ...
              disabled={loading}
              className="animate-element animate-delay-900 w-full flex items-center justify-center gap-3 border border-border rounded-2xl py-4 hover:bg-secondary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
                <GoogleIcon />
